...
with col1:
    st.image("Moon Stone Blue Vinyl.png",edgecolor="Black", caption="Original Photo", width=1080, use_column_width=None, clamp=False, channels='RGB', output_format='auto')
