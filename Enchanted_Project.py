...
def color_analysis(img):
    ...
    plt.figure(figsize = (1, 1), dpi=1080)
...
with col2:
    st.image("color_analysis_report.png", caption="Color Analysis Pie Chart", width=720, use_column_width=None, clamp=False, channels='RGB', output_format='auto')
